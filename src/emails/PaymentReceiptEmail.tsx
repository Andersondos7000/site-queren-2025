...
export default function PaymentReceiptEmail({ orderId, orderUrl }: PaymentReceiptEmailProps) {
  return (
    <html>
      <head>
        <meta charSet="utf-8" />
      ...
      <body className="body">
        <div className="container">
          ...
          <div className="body">
            <p>Recebemos seu pagamento. Seu pedido foi confirmado.</p>
            <p>Pedido: <strong>{orderId}</strong></p>
            <p>
              <a href={orderUrl} className="btn">Ver pedido</a>
            </p>
          </div>
